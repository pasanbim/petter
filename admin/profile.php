...
<head>
    ...
    <title>Admin Profile | Petter</title>
...
<style>
    span.fa-solid.fa-lock.fe-12.mr-2.mb-2 {
  color: #FF7C00;
  font-size: 18px;
  margin-left: 08px;
}
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="row align-items-center my-4">
                            <div class="col">
                                <h3 class="h3 page-title">Admin Profile</h3>
                            </div>
                        </div>
                                        ...
                                        <div class="col">
                                            <div class="row align-items-center">
                                                <div class="col-md-7 mb-4">
                                                    <h3 title="Verfied Admin" class="mb-1">Dr. <?php echo $_SESSION['name']?><span class="fa-solid fa-lock fe-12 mr-2 mb-2"></span></h3>
                                                    <p class="small mb-3"><span class="badge badge-primary" style="padding:5px">Admin</span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
