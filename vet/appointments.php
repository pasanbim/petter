...
<head>
    ...
    <title>Vet Appointments | Petter</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        ...
                        $stmt = $conn->prepare(
                            ...
                            WHERE appointments.status = 'active' AND appointments.type = 'online' AND appointments.vetid = ?
                            ORDER BY appointments.date DESC, appointments.time DESC"
                        );
                        
                        $stmt->bind_param("i", $vetid); // Bind the session vet ID as the vet ID
                        $stmt->execute();
