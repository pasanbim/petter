...
<body class="vertical light">
    <div class="wrapper">
        ...
        $sqlforappointments = "SELECT * FROM appointments WHERE userid = '$userid' AND status = 'active'";
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="row align-items-center mb-2">
                            <div class="col">
                                <h3 class="h3 page-title">Hello <span class="welcomename"><?php echo $_SESSION['name'];?></span>,</h3>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4 my-4">
                                <div class="card shadow">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <strong class="card-title">Pending Reminders</strong>
                                                <p class="small mb-0 mt-1">
                                                    <span class="fe fe-12 fe-arrow-up text-success"></span>
                                                    <span class="text-muted" style="font-size:0.85rem"><a
                                                            style="color:#ADB5BD"
                                                            href="./reminders.php"><?php echo $total_reminders;?></a></span>
                                                </p>
                                            </div>
                                            <div class="col-4 text-right icon-container">
